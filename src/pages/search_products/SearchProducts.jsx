...
export default function SearchProducts() {
  ...
  async function filterProducts(values) {
    const query = {};
    ...
    <>
      ...
      <div className="bg-mainColor py-10">
        <div className="container">
          <h3 className="text-3xl font-bold">Search results for </h3>
          <p className="text-gray-500 mt-2">We found 124 products for you</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 mb-2 gap-x-10 mt-5">
                        ...
                        <div key={index} className="flex flex-col gap-y-4">
                          <label className="flex items-center space-x-2 mb-2 text-gray-700">
                            <input
                              ...
                              onChange={() => {
                                // toggle logic: uncheck if same, else set new
            ...
            <div className="md:col-span-9 ">
              <div className="bg-white p-7 rounded-md"></div>
            </div>
          </div>
        </div>
      </div>
